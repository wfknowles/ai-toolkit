# Brainstorming Session Prompt: Prompt Masstery

*   **Asset Type:** Prompt
*   **Version:** 1.0.0
*   **Location:** `/Users/willknowles/.wfkAi/brain/knowledge/chronological/2025/05/01/prompts/brainstorming-prompt-mastery.md`
...
**Concept(s) Guidance**
Over the past several weeks, I've got from writing simple step by step instructions within markdown to understanding complex prompt workflows, prompt context management, dynamic meta prompts, dynamic prompt creation, prompt orchestration, and other advanced techniques. I work with around 200 other software engineers and I'm wanting to take everything I've learned, experienced, and discovered, and then formalize it so that I can share the knowledge with my team. Could you help me create a concept for an educational course that could teach someone the basics of ai models and agentic ai experiences, techniques, and stratagies. Additionally, it would teach coworkers about interacting with both ai and agentic ai via chat, basic prompting strategies, and provide practical examples for real-world software engineers of how to utilize Cursor into their daily workflow. I want that to be the minimum... or simply the introduction. I want the meat of the course to really do a deep dive into ai, agentic ai, all of the component parts, techniques, strategies, and prompts that one needs to understanding to gain mastery within all things prompt engineering.
...
**output_subdir:**`prompt-mastery`
**absolute_path:**`[output_root/[output_dir]/[output_subdir]`

**output_concept_count:**20
