...
*   **Asset Type:** Prompt
*   **Version:** 1.0.0
*   **Location:** `/Users/wknowles/Develop/ai/wfkAi/brain/knowledge/chronological/2025/04/30/brainstorm-tools/prompts/brainstorming-knowledge-acquisition.md`
...
**Prerequisites**
- `/Users/wknowles/Develop/ai/wfkAi/docs/roadmaps/knowledge_acquisition_roadmap_v1.0.0_2025-04-24.md`

**Concept(s) Guidance**
Over the past several weeks, I've made many "tools" or processes to aid my software engineering work. I've gone from zero to sixty in a very short amount of time. I've a full grasp on agentic workflows and frameworks. I've discovered many new technologies, techniques, patterns, and strategies for working with ai and developing agentic UX. I've iterated so quickly, that I've forgotten what some of the work is and what I was using it for. Could you review what we've created (or analyzed) and then develop full concepts on how to leverage it in some way. In this case, how do we even leverage the existence of a knowledge base? Get creative, give me moonshots. What's new and novel? What's advanced or complex? I want maximum utility. I want maximum specialty. Bring our old work into this brave new world.

**user:**`wknowles`
**output_root:**`/Users/wknowles/Develop/ai/wfkAi/brain/knowledge/chronological/2025/04/30`
...
Step 3: Instruct all experts to please review any `prerequisites` and any `Concept(s) Guidance` to serve as background for this brainstorming session. Have them brainstorm an inital 7 different concepts or ideas so that they might be prepared for a session where they'll all help analyze each other's ideas and concepts, select a top 10 ideas and concepts, and then develop each concept and flesh to their bones, and then refine them into something more actionabale. Please have them write or diagram out their inital concepts. Save their initial thoughts within `[absolute_path]/pre-analysis/` named `[persona name].md`.
