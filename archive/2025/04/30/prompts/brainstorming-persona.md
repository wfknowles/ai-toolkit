...
*   **Asset Type:** Prompt
*   **Version:** 1.0.0
*   **Location:** `/Users/willknowles/.wfkAi/brain/knowledge/chronological/2025/04/30/prompts/brainstorming-persona.md`
...
**Concept(s) Guidance**
Over the past several weeks, I've made many "tools" or processes to aid my software engineering work. I've gone from zero to sixty in a very short amount of time. I've a full grasp on agentic workflows and frameworks. I've discovered many new technologies, techniques, patterns, and strategies for working with ai and developing agentic UX. I've iterated so quickly and focused on learning more advanced techniques, I neglected some other things like creative, clever, or utilitarian ways to utilize persona within prompts. Please brainstorm some really diverse, practical, useful, complex, and/or advanced usages or concepts of persona within the lifecycle of maintaining software.
