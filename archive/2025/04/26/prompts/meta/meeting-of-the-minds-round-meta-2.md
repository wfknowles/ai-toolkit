# Meeting of the Minds - Round 2 Prompt
...
**Prerequisites**
- `/Users/willknowles/.wfkAi/brain/prompts/MotM/meeting-of-the-minds-round-meta.md`
- `/Users/willknowles/.wfkAi/brain/knowledge/chronological/2025/04/26/MotM-meta/round-1/sme-group-interview.md`
- `/Users/willknowles/.wfkAi/brain/knowledge/chronological/2025/04/26/MotM-meta/round-1/analysis.md`
...
Step 2: We need to prepare this round's subdirectory, so within MotM-meta/round-2/ directory, please create the following subdirectories:
- `pre-analysis`
- `sme-interviews`
...
Step 2: Save your full interview here MotM-meta/round-2/sme-interviews/ named `[persona name].md`.
...
Step 3: Step 5: Save the master list of component parts here MotM-meta/ named `requirements.md`.
...
Step 2: Save the full output of the discussion here MotM-meta/round-2/ named `req-analysis.md`.
