...
Step 2: Save your full interview here MotM-mcp/round-2/sme-interviews/ named `[persona name].md`.
...
Step 2: Save the full output of the discussion here MotM-mcp/round-2/ named `req-analysis.md`.
